  ...
  const projects = [
    {
      ...
      title: "Refly",
      description:
        "Share files instantly between devices using QR codes. No signup, no servers, no limits - just pure peer-to-peer magic.",
      category: "fullstack",
    ...
    },
    {
      ...
      category: "fullstack",
      technologies: ["React", "Framer motion", "Tailwind CSS", "Typescript", "Django"],
      year: "2025",
      image: "/recruito.png",
      // github: "swamimalode07/SaaS-Landing-Page",
      live: "https://recruito.perleybrook.com/",
    },
    {
      id: 3,
      title: "Flagman Dashboard",
      description:
        "A IoT product dashboard, with analytics and insights.",
      category: "fullstack",
      technologies: ["React","TypeScript", "Tailwind CSS", "Django"],
      year: "2025",
      image: "/chief-dashboard.png",
      // github: "swamimalode07/anieditor",
      live: "https://apar.flagman.ai/",
    },
    {
      id: 4,
      title: "BeeQuizz",
      description:
        "An interactive quiz and learning platform",
      category: "frontend",
      technologies: ["Figma", "Tailwind CSS", "HTML", "CSS", "Wix"],
      year: "2025",
      image: "/beequizz.png",
      // github: "swamimalode07/clearstatus",
      live: "https://anoobsuresh009.wixsite.com/mysite",
    },
    // {
    //   id: 5,
    //   title: "Simon Game",
